...
import Quiz2QuestionGenerator from "./Quiz2QuestionGenerator";
import classes from "./Quiz2.module.css";

const Quiz2Selection = function () {
  ...
  return (
    <>
      <div className={classes.quiz2Head}>
      ...
      <div>
        {show && (
          <div className={classes.quiz2Body}>
            <div className={classes.quiz2BodyRow}>
            ...
            <div>
              <button onClick={submitHandler} className={classes.quiz2StartBtn}>
                Start Quiz
              </button>
            </div>
          </div>
